    ...
    <div class="wrap">
        <div class="main">
            ...
            <video id="bgvideo" width="1920" height="1080" autoplay loop muted>
                <source src="http://127.0.0.1:3500/video/job/hh/hh-F.mp4" type="video/mp4">
                <source src="http://127.0.0.1:3500/video/job/hh/hh-F.webm" type="video/webm">
            </video>
            <!-- 上 -->
            <div class="top">
                <!-- 门派 -->
                ...
                <div class="top-left">
                    ...
                    <div class="switch-sex">
                        <router-link to="/hh" class="switch switch-f"></router-link>
            ...
            <div class="middle">
                ...
                <div class="skills_box">
                    ...
                    <a href="javascript:;" class="btn_moreskill"></a>
                </div>
            </div>
            <!-- 下 -->
            <div class="bottom">
...
<style scoped>
    .wrap {
        background: url(http://127.0.0.1:3500/img/job/bg_a9188f4.jpg) no-repeat center top;
        width: 100%;
        height: 2180px;
    ...
    .top-right .story {
        background: url(http://127.0.0.1:3500/img/job/story_6d841dc.png);
        position: absolute;
        top: 60px;
        left: auto;
        right: 0;
    ...
    .slogan, .name, .switch-sex, .b-circle, .s-circle, .btn_moreskill:hover, .btn_moreskill, .tit2, .tit1, .b-angel, .s-angel {
        background-image: url(http://127.0.0.1:3500/img/job/hh-f_z_c73ee63.png);
    }
    .slogan {
